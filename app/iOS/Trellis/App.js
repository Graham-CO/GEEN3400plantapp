  ...
  return(
    <Stack.Navigator >
      <Stack.Screen name='PlantScreen' component={PlantScreen} options={{
        title: 'Welcome Home', //title of page
        headerStyle:{
...
function AboutPlants({navigation, route}){
  ...
  return(
    <ScrollView>
      ...
      <View style={styles.container}>
        {/* !! get most recently collected data. get threshholds. */}
         {/* how to store threshold client side? deep linking? */}
        <CircularProgress
          radius={90}
      ...
      !! potentially create a server side library
      <View style = {styles.infoContainer}>
